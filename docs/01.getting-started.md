...
- The app must be created first with `ecewo_create()`, and should start listening last with `ecewo_listen()`. In between, we can register routes and initialize other dependencies.
