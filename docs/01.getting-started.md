...
- The app must be created first with `ecewo()`, and should start listening last with `server_listen()`. In between, we can register routes and initialize other dependencies.
